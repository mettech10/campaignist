...
BUILTIN_PATTERNS: list[dict] = [
    ...
    {
        "id": "builtin:meme-pov-product",
        "label": "Meme — POV product",
        "niche_tags": ["ecommerce", "saas", "local-service"],
        "pattern": {
            "source_url": "builtin:meme-pov-product",
            "format_family": "meme",
            "hook_style": "pov",
            "hook": "POV: you finally found the thing that works",
            "top_text": "POV",
            "bottom_text": "you stopped guessing and just used {product}",
            "hashtags": [],
            "duration_hint_s": 6,
            "caption_rhythm": "hook_then_hashtags",
            "pacing": "fast_cuts",
            "overlay_style": "meme_top_bottom",
            "notes": "Builtin meme template — rebuild with product copy.",
            "provider": "Campaignist",
        },
    },
    {
        "id": "builtin:meme-nobody",
        "label": "Meme — Nobody: / Business:",
        "niche_tags": ["local-service", "ecommerce", "saas"],
        "pattern": {
            "source_url": "builtin:meme-nobody",
            "format_family": "meme",
            "hook_style": "nobody",
            "hook": "Nobody:  / Your business:",
            "top_text": "Nobody:",
            "bottom_text": "{product}: let me make this easy",
            "hashtags": [],
            "duration_hint_s": 5,
            "caption_rhythm": "hook_then_hashtags",
            "pacing": "fast_cuts",
